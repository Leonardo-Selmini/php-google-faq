<?php
  $header = ['Introduzione', 'Norme sulla privacy', 'Termini di servizio', 'Tecnologie', 'Domande frequenti'];
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;700&family=Roboto:wght@100;300;400;500;700;900&display=swap" rel="stylesheet">
</head>
...
<main>
  <?php
    foreach($main as $section){
      echo '<section>'.$section['title'].$section['text'].'</section>';
    }
  ?>
</main>
...
<footer>
  <div class="container">
    ...
    <select name="language" id="lang">
      ...
      <option value="en">English (United Kingdoms)</option>
